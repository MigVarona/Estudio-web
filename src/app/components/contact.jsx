...
const Contact = () => {
  ...
  return (
    <form onSubmit={handleSubmit(onSubmit)}>
      ...
      <div>
        <button
          className={`rounded-md bg-purple-500 py-3 px-8 text-base font-semibold text-white outline-none ${isSubmitting ? 'cursor-not-allowed opacity-50' : 'hover:shadow-form'}`}
          type='submit'
          disabled={isSubmitting}
        >
